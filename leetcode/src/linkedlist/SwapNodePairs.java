...
public class SwapNodePairs {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		LinkedNode current1 = swapNodePairs(input);
	...
	private static LinkedNode swapNodePairs(LinkedNode head) {
		...
		while(prev.next!=null && prev.next.next!=null) {
			...
			LinkedNode first = prev.next;
			LinkedNode second = prev.next.next;
